...
update public.rooms
set palette_size = 12
where palette_size = 8;

alter table public.rooms
  alter column palette_size set default 12,
  add constraint rooms_palette_size_check check (palette_size in (12, 16));
...
begin
  ...
  if palette_size_value not in (12, 16) then
      ...
      or (
        ...
        and (
          (
            ...
            and coalesce(pixel.change->>'color', '') not in (
